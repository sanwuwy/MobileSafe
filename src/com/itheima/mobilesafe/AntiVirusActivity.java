...
public class AntiVirusActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RotateAnimation ra = new RotateAnimation(0, 360, Animation.RELATIVE_TO_SELF, 1.0f, Animation.RELATIVE_TO_SELF,
                1.0f);
        ra.setDuration(2000);
            ...
            protected Void doInBackground(Void... params) {
                try {
                    ...
                    for (PackageInfo packinfo : packinfos) {
                        ...
                        publishProgress("正在扫描:" + packinfo.applicationInfo.loadLabel(pm).toString(), packinfo, isvirus);
                        total++;
