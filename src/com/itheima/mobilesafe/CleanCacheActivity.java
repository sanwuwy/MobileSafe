    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new AsyncTask<Void, Object, Void>() {
            ...
            protected void onPostExecute(Void result) {
                ...
                if (cacheMap.size() > 0) {
                    ...
                    for (Entry<String, Long> entry : set) {
                        ...
                        final View view = View.inflate(getApplicationContext(), R.layout.list_item_cache_item, null);
                        ImageView iv_icon = (ImageView) view.findViewById(R.id.iv_cache_item_icon);
                        TextView tv_name = (TextView) view.findViewById(R.id.tv_cache_item_name);
                        TextView tv_size = (TextView) view.findViewById(R.id.tv_cache_item_size);
                        ImageView iv_delete = (ImageView) view.findViewById(R.id.iv_cache_item_delete);
                        ...
                        try {
                            ...
                            iv_icon.setImageDrawable(getResources().getDrawable(R.drawable.ic_default));
                        }

                        tv_size.setText("缓存大小:" + Formatter.formatFileSize(getApplicationContext(), size));
            ...
            protected void onProgressUpdate(Object... values) {
                ...
                tv_status.setText("正在扫描:" + packinfo.applicationInfo.loadLabel(pm));
...
//                    new Class[] { String.class, IPackageDataObserver.class });
//            method.invoke(pm, new Object[] { packname, new MyPackDataObserver() });
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == 0) {
            ll_container.removeView(removeView);
        }
